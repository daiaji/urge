...
struct URGE_OBJECT(GPUDepthStencilStateDesc) {
  ...
  scoped_refptr<scoped_refptr<GPUStencilOpDesc>> front_face;
  scoped_refptr<scoped_refptr<GPUStencilOpDesc>> back_face;
};
...
struct URGE_OBJECT(GPUGraphicsPipelineDesc) {
  scoped_refptr<scoped_refptr<GPUBlendStateDesc>> blend_desc;
  uint32_t sample_mask;
  scoped_refptr<scoped_refptr<GPURasterizerStateDesc>> rasterizer_desc;
  scoped_refptr<scoped_refptr<GPUDepthStencilStateDesc>> depth_stencil_desc;
...
struct URGE_OBJECT(GPUImmutableSamplerDesc) {
  ...
  scoped_refptr<scoped_refptr<GPUSamplerDesc>> desc;
};

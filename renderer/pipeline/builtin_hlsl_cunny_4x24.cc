...
// Generated by tools/generate_cunny_hlsl.py from Magpie CuNNy-4x24-NVL.hlsl.
// Source SHA256: 65acb3b72231baaafe11b98766cc4be0ae2068c599cbfb8f7307888b2cbd2054
// CuNNy_4x24 Pass1: in (3x24)
extern const std::string kHLSL_CuNNy_4x24_Pass1_Pixel = R"(
Texture2D u_Texture;
SamplerState u_Texture_sampler;

RWTexture2D<float4> u_Output0;
RWTexture2D<float4> u_Output1;
RWTexture2D<float4> u_Output2;
RWTexture2D<float4> u_Output3;
RWTexture2D<float4> u_Output4;
RWTexture2D<float4> u_Output5;
...
// CuNNy_4x24 Pass2: conv1 (24x24)
extern const std::string kHLSL_CuNNy_4x24_Pass2_Pixel = R"(
Texture2D u_Texture0;
SamplerState u_Texture0_sampler;
...
R"(	r1 = MulAdd(s1_0_0, M4(5.783e-02, 5.364e-02, -5.878e-02, -1.603e-01, 1.268e-01, -3.057e-02, 3.843e-01, 1.301e-01, -7.438e-02, -5.585e-02, 8.703e-03, 8.822e-02, -1.626e-01, 6.111e-02, -6.456e-01, 2.891e-01), r1);
...
R"(	r1 = MulAdd(s0_1_0, M4(4.189e-02, 2.017e-02, 1.886e-02, -1.862e-02, 2.407e-01, -4.790e-02, 2.744e-01, -2.434e-01, -2.856e-02, -4.888e-02, -8.336e-02, 8.936e-02, 4.352e-02, -1.079e-01, 2.488e-02, -6.129e-02), r1);
...
R"(	r3 = MulAdd(s1_2_0, M4(3.385e-02, 1.897e-01, -1.337e-01, 2.788e-02, 4.957e-02, -9.340e-02, 4.440e-02, 1.078e-01, -6.039e-02, -3.368e-01, 2.864e-01, 4.994e-03, 2.456e-02, 9.198e-02, 7.582e-02, 8.453e-02), r3);
...
R"(	r3 = MulAdd(s1_0_0, M4(-4.563e-02, 1.308e-02, -6.613e-02, 5.080e-02, 5.706e-02, 2.216e-01, -1.205e-01, -5.547e-02, -2.750e-01, 6.719e-04, 2.072e-01, 1.757e-01, 5.622e-02, 2.066e-01, 8.210e-02, 3.266e-02), r3);
...
// CuNNy_4x24 Pass3: conv2 (24x24)
extern const std::string kHLSL_CuNNy_4x24_Pass3_Pixel = R"(
Texture2D u_Texture6;
SamplerState u_Texture6_sampler;
Texture2D u_Texture7;
SamplerState u_Texture7_sampler;
Texture2D u_Texture8;
SamplerState u_Texture8_sampler;
Texture2D u_Texture9;
SamplerState u_Texture9_sampler;
Texture2D u_Texture10;
SamplerState u_Texture10_sampler;
Texture2D u_Texture11;
SamplerState u_Texture11_sampler;
...
R"(	r1 = MulAdd(s1_0_0, M4(2.509e-01, -1.608e-02, 8.565e-02, -1.464e-02, -2.686e-02, -8.832e-02, -3.478e-02, -3.390e-02, -1.663e-01, -2.596e-01, 1.014e-02, 2.844e-02, -6.856e-02, -2.251e-02, 1.800e-02, -3.053e-03), r1);
...
R"(	r1 = MulAdd(s0_1_0, M4(1.586e-01, 1.163e-01, -6.704e-02, 4.168e-03, 3.899e-03, -1.634e-01, -7.974e-02, -8.093e-03, 3.003e-02, 2.979e-02, -9.012e-02, -6.960e-03, 3.543e-03, -4.452e-02, -2.551e-01, -2.215e-02), r1);
...
R"(	r3 = MulAdd(s1_2_0, M4(3.183e-02, -2.038e-02, -1.889e-02, -3.319e-02, -6.275e-03, 3.323e-02, -4.868e-02, 2.673e-02, -3.429e-02, -7.936e-02, -9.981e-03, 1.453e-01, 3.156e-02, -2.671e-02, -5.026e-02, 6.185e-02), r3);
...
R"(	r3 = MulAdd(s1_0_0, M4(3.165e-02, -6.799e-02, -1.148e-01, -8.661e-02, -4.539e-02, 2.937e-01, 1.245e-01, 2.626e-01, 4.480e-02, 4.277e-02, 1.900e-01, 1.566e-02, 2.412e-02, 2.317e-02, -6.464e-02, 1.929e-01), r3);
...
// CuNNy_4x24 Pass4: conv3 (24x24)
extern const std::string kHLSL_CuNNy_4x24_Pass4_Pixel = R"(
Texture2D u_Texture0;
SamplerState u_Texture0_sampler;
Texture2D u_Texture1;
SamplerState u_Texture1_sampler;
...
R"(	r1 = MulAdd(s1_0_0, M4(4.245e-02, -6.761e-02, 3.573e-02, -5.727e-01, 4.042e-02, 2.672e-01, 5.271e-02, -8.365e-01, -2.273e-02, 1.575e-01, -1.530e-02, -5.521e-02, 3.424e-02, 6.701e-02, 5.303e-02, 1.626e-01), r1);
...
R"(	r2 = MulAdd(s0_1_0, M4(-2.521e-02, 4.696e-02, 2.388e-02, 1.202e-02, 2.781e-02, -7.500e-02, -3.001e-02, 4.018e-02, -1.242e-01, -1.199e-01, 2.672e-01, 3.484e-01, -2.247e-02, -1.037e-01, 1.438e-02, -8.825e-03), r2);
...
R"(	r4 = MulAdd(s1_2_0, M4(1.492e-02, 7.382e-04, -7.303e-02, 1.716e-02, 5.335e-02, -5.337e-03, -9.926e-02, -3.552e-02, 9.434e-03, 1.877e-02, -1.032e-02, -4.140e-03, -1.330e-02, -9.041e-03, 1.236e-01, -3.480e-03), r4);
...
R"(	r4 = MulAdd(s1_0_0, M4(1.456e-02, 4.653e-02, 4.523e-02, 1.747e-02, -8.928e-03, -9.703e-02, -8.875e-02, -1.769e-02, 1.502e-02, -4.352e-02, -1.263e-01, 5.017e-02, -5.159e-03, 3.670e-02, 1.923e-02, 4.919e-03), r4);
...
// CuNNy_4x24 Pass5: conv4 (24x24)
extern const std::string kHLSL_CuNNy_4x24_Pass5_Pixel = R"(
Texture2D u_Texture6;
SamplerState u_Texture6_sampler;
Texture2D u_Texture7;
SamplerState u_Texture7_sampler;
...
R"(	r1 = MulAdd(s1_0_0, M4(-2.227e-02, -6.746e-02, 6.695e-03, 6.017e-04, 1.577e-02, -5.935e-03, 7.167e-03, -2.705e-02, 4.107e-02, 1.183e-01, -4.966e-03, -4.257e-03, -2.162e-02, -2.582e-02, -1.227e-03, -1.179e-01), r1);
...
R"(	r1 = MulAdd(s0_1_0, M4(1.315e-02, -8.415e-02, -2.960e-02, -2.147e-02, 9.850e-03, 3.992e-02, 3.961e-03, 2.813e-02, 6.228e-02, 1.794e-02, 4.539e-03, -2.484e-02, -7.237e-02, -5.464e-02, -5.172e-02, -1.986e-02), r1);
...
R"(	r3 = MulAdd(s1_2_0, M4(6.013e-02, 5.187e-03, -5.586e-03, 5.851e-02, -5.328e-02, 9.366e-03, 2.400e-02, -1.631e-02, -1.507e-03, 1.064e-02, 7.565e-03, -3.324e-02, -1.610e-02, 3.171e-02, -1.031e-02, 2.009e-02), r3);
...
R"(	r3 = MulAdd(s1_0_0, M4(-1.538e-02, -3.460e-04, -4.056e-03, -3.965e-03, 6.089e-02, -5.203e-03, 4.640e-03, -5.131e-02, 6.666e-02, 2.606e-02, -1.043e-02, 7.490e-02, -1.400e-02, -8.286e-03, -5.660e-03, 4.542e-02), r3);
...
// CuNNy_4x24 Pass6: out-shuffle (24x12)
extern const std::string kHLSL_CuNNy_4x24_Pass6_Pixel = R"(
Texture2D u_Texture;
SamplerState u_Texture_sampler;
Texture2D u_Texture0;
SamplerState u_Texture0_sampler;
...
R"(	r0 = MulAdd(s0_0_0, M4(1.297e-02, 3.403e-04, 2.284e-03, 1.404e-03, 1.509e-02, 5.169e-03, -2.517e-03, -3.511e-04, 6.510e-03, -1.720e-03, -8.420e-04, 1.159e-03, -2.342e-03, 8.941e-03, -3.242e-03, -1.085e-03), r0);
...
R"(	r1 = MulAdd(s0_2_0, M4(8.442e-03, -9.426e-04, 8.456e-03, -3.592e-03, -2.019e-03, -5.636e-04, -3.596e-03, 6.508e-04, -2.292e-03, -7.316e-04, 5.359e-03, 2.790e-03, -2.079e-03, 1.133e-03, 1.223e-02, -2.174e-03), r1);
	...
	float2 opt = u_OutputPt, fpos = (float2(gxy) + 0.5) * opt;
	uint2 out_xy0 = gxy + int2(0, 0);
	if (out_xy0.x < uint(u_OutputSize.x) && out_xy0.y < uint(u_OutputSize.y))
		u_Output[out_xy0] = MF4(saturate(INPUT.SampleLevel(SL, fpos + float2(0.0, 0.0) * opt, 0).rgb + MF3(r0.x, r1.x, r2.x)), 1.0);
	uint2 out_xy1 = gxy + int2(1, 0);
	if (out_xy1.x < uint(u_OutputSize.x) && out_xy1.y < uint(u_OutputSize.y))
		u_Output[out_xy1] = MF4(saturate(INPUT.SampleLevel(SL, fpos + float2(1.0, 0.0) * opt, 0).rgb + MF3(r0.y, r1.y, r2.y)), 1.0);
	uint2 out_xy2 = gxy + int2(0, 1);
	if (out_xy2.x < uint(u_OutputSize.x) && out_xy2.y < uint(u_OutputSize.y))
		u_Output[out_xy2] = MF4(saturate(INPUT.SampleLevel(SL, fpos + float2(0.0, 1.0) * opt, 0).rgb + MF3(r0.z, r1.z, r2.z)), 1.0);
	uint2 out_xy3 = gxy + int2(1, 1);
	if (out_xy3.x < uint(u_OutputSize.x) && out_xy3.y < uint(u_OutputSize.y))
		u_Output[out_xy3] = MF4(saturate(INPUT.SampleLevel(SL, fpos + float2(1.0, 1.0) * opt, 0).rgb + MF3(r0.w, r1.w, r2.w)), 1.0);
}

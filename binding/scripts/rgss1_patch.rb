...
module RPG
  ...
  class Sprite < ::Sprite
    ...
    def animation(animation, hit)
      ...
      if @@_reference_count.include?(bitmap.engine_id)
        @@_reference_count[bitmap.engine_id] += 1
      else
        @@_reference_count[bitmap.engine_id] = 1
      end
      @_animation_sprites = []
    ...
    def dispose_animation
      if @_animation_sprites != nil
        ...
        if sprite != nil
          @@_reference_count[sprite.bitmap.engine_id] -= 1
          if @@_reference_count[sprite.bitmap.engine_id] == 0

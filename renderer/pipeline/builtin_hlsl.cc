...
void PSMain(in PSInput PSIn, out PSOutput PSOut) {
  ...
  float2 uv = PSIn.UV;
  {
      ...
      float _63 = _61;
      float _65 = _63;
      PSOut.Color = float4(_32, _61, _63, _65) + u_Texture.Sample(u_Texture_sampler, uv);
}
})";

...
| 功能 | 说明 |
|------|------|
| **SFNT 全量族名索引** | 启动时通过 FreeType 遍历字体的 SFNT name table，索引所有族名。`Font.default_name="LGBaseFont"` 等族名可自动匹配到对应字体文件。支持 UTF-16BE 解码，跨平台。 |
...
| **VDMX/OS2 ppem 计算** | `font.cpp:load_VDMX/calc_ppem_for_height` | 精确模拟 Windows GDI 字号 | 纯 RGSS 特化，需 FreeType 表解析 |

...
// Generated by tools/generate_cunny_hlsl.py from Magpie CuNNy-4x16-NVL.hlsl.
// Source SHA256: df0f8c5d233777997d32d6dc064b88e6181c26dbf4987fd1471cf569d700fd81
// CuNNy_4x16 Pass1: in (3x16)
extern const std::string kHLSL_CuNNy_4x16_Pass1_Pixel = R"(
Texture2D u_Texture;
...
// CuNNy_4x16 Pass2: conv1 (16x16)
extern const std::string kHLSL_CuNNy_4x16_Pass2_Pixel = R"(
...
R"(	r0 = MulAdd(s1_1_2, M4(3.896e-01, 4.771e-01, 2.362e-01, 1.370e-01, -2.130e-02, -1.543e-01, 5.252e-02, 4.703e-01, 2.130e-01, 2.542e-01, 1.870e-01, -7.936e-02, 4.324e-02, -1.922e-01, -1.204e-01, -3.205e-01), r0);
...
R"(	r0 = MulAdd(s1_1_2, M4(8.428e-02, 6.548e-02, 3.540e-02, 2.329e-02, 5.127e-02, -1.418e-02, -2.721e-03, 1.628e-01, 5.499e-03, -1.984e-02, 2.535e-02, 6.768e-02, 4.668e-02, -4.796e-02, 7.106e-03, -1.008e-01), r0);
...
// CuNNy_4x16 Pass3: conv2 (16x16)
extern const std::string kHLSL_CuNNy_4x16_Pass3_Pixel = R"(
...
R"(	r0 = MulAdd(s1_1_2, M4(-4.611e-02, -2.300e-01, -1.014e-01, 2.198e-01, -1.457e-02, -1.833e-01, 5.132e-01, 1.266e-01, -3.557e-01, 1.384e-01, 4.480e-02, -1.603e-01, 1.259e-01, -1.723e-01, -1.515e-01, -9.154e-02), r0);
...
R"(	r0 = MulAdd(s1_1_2, M4(1.880e-01, -3.698e-01, -1.253e-01, 5.844e-02, -1.422e-01, -5.347e-02, -6.134e-01, -4.550e-02, 3.001e-01, 2.434e-01, -1.661e-01, 6.991e-02, -9.822e-02, -5.598e-02, 7.314e-02, -1.877e-01), r0);
...
// CuNNy_4x16 Pass4: conv3 (16x16)
extern const std::string kHLSL_CuNNy_4x16_Pass4_Pixel = R"(
Texture2D u_Texture0;
SamplerState u_Texture0_sampler;
Texture2D u_Texture1;
SamplerState u_Texture1_sampler;
...
R"(	r0 = MulAdd(s1_1_2, M4(1.704e-01, 2.341e-01, -5.514e-02, 1.630e-02, -3.880e-01, -4.036e-02, -3.677e-02, -1.358e-01, -7.230e-02, -1.949e-01, 5.907e-03, -6.975e-03, -1.077e-01, -2.125e-01, 8.487e-02, -6.423e-02), r0);
...
R"(	r0 = MulAdd(s1_1_2, M4(4.179e-01, 3.328e-01, 1.174e-01, -3.259e-02, -1.720e-01, -1.034e-01, -7.183e-03, -6.683e-02, -1.751e-01, -2.145e-01, -8.325e-02, -1.282e-01, -2.981e-01, -2.145e-01, -3.291e-01, 1.933e-03), r0);
...
// CuNNy_4x16 Pass5: conv4 (16x16)
extern const std::string kHLSL_CuNNy_4x16_Pass5_Pixel = R"(
Texture2D u_Texture4;
SamplerState u_Texture4_sampler;
Texture2D u_Texture5;
SamplerState u_Texture5_sampler;
...
R"(	r0 = MulAdd(s1_1_2, M4(3.159e-02, -2.459e-02, 1.481e-02, -4.284e-02, -9.918e-02, 4.626e-02, 1.158e-03, -4.064e-02, 3.869e-02, 9.447e-02, -9.356e-03, 3.034e-02, -7.447e-02, 5.891e-02, -5.085e-03, -2.565e-02), r0);
...
R"(	r0 = MulAdd(s1_1_2, M4(2.439e-01, -2.270e-01, -7.154e-03, 1.268e-02, -2.635e-01, -5.136e-03, 5.017e-02, 5.398e-02, -5.108e-02, -1.406e-02, 4.618e-02, -4.488e-02, -7.836e-02, -9.523e-02, -1.754e-01, -2.359e-01), r0);
...
// CuNNy_4x16 Pass6: out-shuffle (16x12)
extern const std::string kHLSL_CuNNy_4x16_Pass6_Pixel = R"(
Texture2D u_Texture;
SamplerState u_Texture_sampler;
Texture2D u_Texture0;
SamplerState u_Texture0_sampler;
...
R"(	r0 = MulAdd(s0_0_0, M4(-6.438e-03, -3.129e-03, 3.253e-03, 3.653e-03, -2.017e-01, -5.363e-04, 2.255e-03, 4.920e-02, 1.602e-02, -5.146e-03, 1.079e-02, -1.125e-03, -6.762e-02, 2.322e-02, -2.198e-02, 2.321e-02), r0);
